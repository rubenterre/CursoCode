...
var nome = prompt("Introduce o teu nome"); alert("Ola, " + nome + "!");

// Exercicio 2: Suma de dous números
var num1 = parseFloat(prompt("Introduce o primeiro número")); var num2 = parseFloat(prompt("Introduce o segundo número")); var suma = num1 + num2;
alert("A suma é: " + suma);
